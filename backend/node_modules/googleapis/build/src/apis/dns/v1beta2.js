...
(function (dns_v1beta2) {
    ...
    class Resource$Projects$Managedzones {
        constructor(context) {
            this.context = context;
            this.rrsets = new Resource$Projects$Managedzones$Rrsets(this.context);
        }
    }
    dns_v1beta2.Resource$Projects$Managedzones = Resource$Projects$Managedzones;
    class Resource$Projects$Managedzones$Rrsets {
        constructor(context) {
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
    ...
    dns_v1beta2.Resource$Projects$Managedzones$Rrsets = Resource$Projects$Managedzones$Rrsets;
