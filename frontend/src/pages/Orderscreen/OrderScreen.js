   ...
   const successpaymenthandler = (paymentResult) =>{
    ...
    return (
          ...
          <div className="checkout">
              {order.isPaid ? <Alert message="This Order is Paid"  type="success" showIcon closable/> : <Alert message="This Order is Not Paid Yet" type="error" showIcon closable/>}
          ...
          <div className="countryPayment">
                ...
                <div>
                    <span>Name: </span><b>{order.user.name.toUpperCase()}</b>
                </div>
                <div>
                    <span>E-mail: </span><b>{order.user.email}</b>
                </div>
                <div>
                    <span>Country: </span><b>{order.countryCustomer.country}</b>
                </div>
                <div>
                    <span>Payment Method: </span><b>{order.paymentMethod}</b>
                </div>
                {order.isPaid &&
                <div>
                    <span>Paid At: </span><b>{order.paidAt}</b>
                </div>
                }
                </div>
...
<hr></hr>
                  ...
                  <h2>Total = </h2><b className="totalPriceNumberOrder">${order.totalPrice}</b>
                  </div>
                  </div>
          ...
          {!order.isPaid &&<div className = 'paypalbuttons'>
              ...
              <p>By completing your purchase you agree to <a href="/">Terms of Service.</a></p>
                    <p className="payParagraph">Now You Have Just To Pay To Have Access To The Course</p>
                                           ...
                                           <div className="keepOrderId">
                                            <h2>Warning !</h2>   
                                            <p>For Security And Purchase Success, You Should Keep The Order ID Saved And If You Faced Any Problem Just Send Us Short Description With The Order ID</p>
